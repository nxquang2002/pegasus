...
def get_config():
    ...
    config.dataset_name = "big_patent/d"
    ...
    # Replace this:
    config.eval_load_checkpoint_dir = "/checkpoints/checkpoint_1800000"

    # Replace this:
    config.tokenizer_path = "./tokenizer/c4.unigram.newline.10pct.96000.model"
