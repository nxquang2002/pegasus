...
def get_config():
    ...
    config.dataset_name = "gov_report/crs_whitespace"
    ...
    # Replace this:
    config.eval_load_checkpoint_dir = "content/pegasus/pegasus/flax/checkpoints/checkpoint_1800000"

    # Replace this:
    config.tokenizer_path = "content/pegasus/pegasus/flax/tokenizer/c4.unigram.newline.10pct.96000.model"
